...
from .blueprints import signer_blueprint, user_blueprint, raffles_blueprint
...
deps.register_blueprint(user_blueprint, url_prefix="/user")
deps.register_blueprint(signer_blueprint, url_prefix="/signer")
deps.register_blueprint(raffles_blueprint, url_prefix="/raffles")

app.register_error_handler(ApiException, handle_api_exception)
# app.register_error_handler(Exception, handle_exception)

app.secret_key = "placeholder_secret"   # TODO: use config
